...
db-local: migrate-up-local roles-sync-local seed-local
db-remote: migrate-up-remote roles-sync-remote seed-remote
...
.PHONY: db-local db-remote seed-local seed-remote migrate-up-local migrate-up-remote migrate-down-local migrate-down-remote migrate-force-local migrate-force-remote roles-sync-local roles-sync-remote migrate-up migrate-down migrate-force migrateup migratedown migrateforce migrateup-local migratedown-local migrateforce-local migrateup-remote migratedown-remote migrateforce-remote sqlc test server mockdb swagger roles admin seed push update-proto generate-grpc lint mocks
