...
//
//	mockgen -source=client.go -destination=../async/mocks/mock_asynq_client.go -package=asyncmocks
//
...
func (m *MockAsynqClientInterface) EnqueueAcceptedRegistration(ctx context.Context, payload async.AcceptedRegistrationFormPayload, opts ...asynq.Option) error {
	m.ctrl.T.Helper()
...
func (m *MockAsynqClientInterface) EnqueueAppointmentTask(ctx context.Context, payload async.AppointmentPayload, opts ...asynq.Option) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, payload}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockAsynqClientInterface) EnqueueEmailDelivery(payload async.EmailDeliveryPayload, ctx context.Context, opts ...asynq.Option) error {
	m.ctrl.T.Helper()
...
func (m *MockAsynqClientInterface) EnqueueIncident(payload async.IncidentPayload, ctx context.Context, opts ...asynq.Option) error {
	m.ctrl.T.Helper()
	varargs := []any{payload, ctx}
	for _, a := range opts {
		varargs = append(varargs, a)
