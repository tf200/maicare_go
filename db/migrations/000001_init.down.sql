...
DROP TABLE IF EXISTS "public".client_goal_evaluation_items CASCADE;
DROP TABLE IF EXISTS "public".client_goal_evaluations CASCADE;
...
-- Deprecated legacy care-plan assessment model:
...
-- Deprecated legacy care-plan assessment model enums:
