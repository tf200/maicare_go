...
DROP TABLE IF EXISTS invoice_number_counter CASCADE;
...
DROP TABLE IF EXISTS departments CASCADE;
  ...
  DROP TABLE IF EXISTS registration_upload_sessions CASCADE;
...
DROP TABLE IF EXISTS rls_client_creation_context CASCADE;
DROP TABLE IF EXISTS rls_report_creation_context CASCADE;
DROP TABLE IF EXISTS rls_registration_submission_context CASCADE;
...
DROP FUNCTION IF EXISTS get_invoice_paid_total(UUID) CASCADE;
DROP FUNCTION IF EXISTS allocate_invoice_sequence_for_date(TIMESTAMPTZ) CASCADE;
DROP FUNCTION IF EXISTS attach_generated_invoice_pdf(UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS can_manage_invoice_run(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_access_registration_form(UUID, TEXT) CASCADE;
DROP FUNCTION IF EXISTS can_access_intake_form(UUID, TEXT) CASCADE;
DROP FUNCTION IF EXISTS can_create_intake_form(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_access_intake_assessment(UUID, TEXT) CASCADE;
DROP FUNCTION IF EXISTS can_read_intake_promotion_source(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_public_registration_submission(TEXT, UUID[]) CASCADE;
DROP FUNCTION IF EXISTS authorize_public_registration_insert(UUID, UUID[]) CASCADE;
DROP FUNCTION IF EXISTS can_read_public_submitted_registration(UUID) CASCADE;
DROP FUNCTION IF EXISTS consume_public_registration_submission(UUID) CASCADE;
DROP FUNCTION IF EXISTS get_public_intake_options(TEXT) CASCADE;
...
DROP FUNCTION IF EXISTS can_access_invoice_payment_record(UUID, UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS get_payment_operation_completed_sum(UUID) CASCADE;
DROP FUNCTION IF EXISTS recalculate_invoice_payment_status(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_invoice_payment_operation(UUID, TEXT, UUID) CASCADE;
DROP FUNCTION IF EXISTS set_group_f_ownership() CASCADE;
DROP FUNCTION IF EXISTS set_updated_at() CASCADE;
DROP FUNCTION IF EXISTS set_medical_actor_attribution() CASCADE;
DROP FUNCTION IF EXISTS set_incident_reporter_actor() CASCADE;
DROP FUNCTION IF EXISTS set_group_e_actor_and_ownership() CASCADE;
DROP FUNCTION IF EXISTS set_attachment_actor() CASCADE;
DROP FUNCTION IF EXISTS validate_client_document_attachment() CASCADE;
DROP FUNCTION IF EXISTS confirm_incident(UUID) CASCADE;
DROP FUNCTION IF EXISTS mark_incident_confirmation_email_sent(UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS mark_incident_confirmation_email_sent(UUID) CASCADE;
DROP FUNCTION IF EXISTS claim_incident_confirmation_email(UUID) CASCADE;
DROP FUNCTION IF EXISTS release_incident_confirmation_email(UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS release_incident_confirmation_email(UUID) CASCADE;
...
DROP FUNCTION IF EXISTS can_read_created_ai_report(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_ai_report_creation(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_read_created_progress_report(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_progress_report_creation(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_read_created_client_medication(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_client_medication_creation(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_read_created_client_diagnosis(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_client_diagnosis_creation(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_read_created_incident(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_incident_creation(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_read_created_client_document(UUID) CASCADE;
DROP FUNCTION IF EXISTS begin_client_document_creation(UUID) CASCADE;
DROP FUNCTION IF EXISTS client_has_draft_evaluation_for_goal_update(UUID) CASCADE;
DROP FUNCTION IF EXISTS goal_has_evaluation_history_for_update(UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS can_mutate_goal_evaluation(UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS attachment_file_is_referenced(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_access_actor_attachment(UUID) CASCADE;
DROP FUNCTION IF EXISTS release_deleted_client_document_attachment() CASCADE;
DROP FUNCTION IF EXISTS can_access_client(UUID, TEXT) CASCADE;
DROP FUNCTION IF EXISTS is_assigned_to_client(UUID) CASCADE;
DROP FUNCTION IF EXISTS get_permission_scope(TEXT) CASCADE;
