DROP INDEX IF EXISTS public.client_goal_evaluations_draft_client_updated_idx;
DROP INDEX IF EXISTS public.client_goal_evaluations_employee_draft_updated_idx;
DROP INDEX IF EXISTS public.client_goal_evaluations_employee_completed_updated_idx;
...
DROP FUNCTION IF EXISTS evaluation_business_date(TIMESTAMPTZ);
