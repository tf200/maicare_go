...
type ListRegistrationFormsRequest struct {
	pagination.Request
	Status                 *string `form:"status" json:"status" binding:"omitempty,oneof=pending processed rejected"`
...
type UpdateRegistrationFormStatusRequest struct {
	Status                    string    `json:"status" binding:"required,oneof=pending processed rejected" example:"processed"`
	IntakeAppointmentDate     time.Time `json:"intake_appointment_date" binding:"required_if=Status processed" example:"2023-10-01T10:00:00Z"`
	IntakeAppointmentLocation *string   `json:"intake_appointment_location" binding:"required_if=Status processed" example:"Amsterdam Central Station"`
	AddmissionType            *string   `json:"admission_type" binding:"required_if=Status processed,oneof=crisis_admission regular_placement" example:"regular_placement"`
