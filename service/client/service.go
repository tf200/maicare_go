...
type ClientService interface {
	...
	ListLocationTransferRequests(ctx *gin.Context, req ListLocationTransferRequestsRequest, clientID uuid.UUID) (*pagination.Response[ListLocationTransferRequestsResponse], error)
}
