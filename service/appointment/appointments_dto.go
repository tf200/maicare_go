...
type CreateAppointmentRequest struct {
	...
	RecurrenceType         string      `json:"recurrence_type" example:"NONE" enum:"NONE,DAILY,WEEKLY,MONTHLY" binding:"required,oneof=NONE DAILY WEEKLY MONTHLY"`
...
type AddParticipantToAppointmentRequest struct {
	ParticipantEmployeeIDs []uuid.UUID `json:"participant_employee_ids" binding:"required"`
}
...
type AddClientToAppointmentRequest struct {
	ClientIDs []uuid.UUID `json:"client_ids" binding:"required"`
}
