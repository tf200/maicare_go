...
type registrationEducationRequest struct {
	...
	Level             string  `json:"level" binding:"omitempty,oneof=primary secondary higher none"`
}

type registrationWorkRequest struct {
...
type registrationEducationUpdateRequest struct {
	Institution       *string `json:"institution"`
	MentorName        *string `json:"mentor_name"`
	MentorPhone       *string `json:"mentor_phone"`
	MentorEmail       *string `json:"mentor_email"`
...
type registrationWorkUpdateRequest struct {
	CurrentEmployer   *string `json:"current_employer"`
	EmployerPhone     *string `json:"employer_phone"`
	EmployerEmail     *string `json:"employer_email"`
	CurrentPosition   *string `json:"current_position"`
...
type updateRegistrationFormRequest struct {
	...
	Education                     *registrationEducationUpdateRequest `json:"education"`
	Work                          *registrationWorkUpdateRequest      `json:"work"`
	CareProtectedLiving           *bool                               `json:"care_protected_living"`
	CareAssistedIndependentLiving *bool                               `json:"care_assisted_independent_living"`
	CareRoomTrainingCenter        *bool                               `json:"care_room_training_center"`
	CareAmbulatoryGuidance        *bool                               `json:"care_ambulatory_guidance"`
...
type replaceRegistrationFormDocumentRequest struct {
	DocumentType string    `json:"document_type" binding:"required"`
	FileID       uuid.UUID `json:"file_id" binding:"required"`
}

var supportedRegistrationDocumentTypes = map[string]bool{
	"document_referral":           true,
	"document_education_report":   true,
	"document_action_plan":        true,
	"document_psychiatric_report": true,
	"document_diagnosis":          true,
	"document_safety_plan":        true,
	"document_id_copy":            true,
}
...
type registrationEducationResponse struct {
	Institution       *string `json:"institution"`
	MentorName        *string `json:"mentor_name"`
	MentorPhone       *string `json:"mentor_phone"`
	MentorEmail       *string `json:"mentor_email"`
...
func toRegistrationFormResponse(f domain.RegistrationForm) registrationFormResponse {
	return registrationFormResponse{
		...
		Education: registrationEducationResponse{
			Institution:       f.EducationInstitution,
			MentorName:        f.EducationMentorName,
			MentorPhone:       f.EducationMentorPhone,
			MentorEmail:       f.EducationMentorEmail,
			CurrentlyEnrolled: f.EducationCurrentlyEnrolled,
			AdditionalNotes:   f.EducationAdditionalNotes,
			Level:             f.EducationLevel,
		},
		Work: workResponse{
			CurrentEmployer:   f.WorkCurrentEmployer,
			EmployerPhone:     f.WorkEmployerPhone,
...
func toCreateRegistrationFormParams(req createRegistrationFormRequest) (domain.CreateRegistrationFormParams, error) {
	...
	params := domain.CreateRegistrationFormParams{
	...
	if req.Education != nil {
		params.EducationInstitution = req.Education.Institution
		params.EducationMentorName = req.Education.MentorName
	...
	if req.Work != nil {
		...
		params.WorkEmployerEmail = req.Work.EmployerEmail
...
func toUpdateRegistrationFormParams(id uuid.UUID, req updateRegistrationFormRequest) (domain.UpdateRegistrationFormParams, error) {
	...
	params := domain.UpdateRegistrationFormParams{
		ID:                            id,
		ClientFirstName:               req.ClientFirstName,
		ClientLastName:                req.ClientLastName,
		ClientDateOfBirth:             clientDateOfBirth,
