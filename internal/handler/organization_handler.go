...
func RegisterOrganizationRoutes(
	...
	rg.POST("/organizations", auth, requirePermission(domain.PermOrganisationCreate.String()), handler.CreateOrganization)
	rg.GET("/organizations", auth, requirePermission(domain.PermOrganisationView.String()), handler.ListOrganizations)
	rg.GET("/organizations/:id", auth, requirePermission(domain.PermOrganisationView.String()), handler.GetOrganizationByID)
	rg.GET("/organizations/:id/counts", auth, requirePermission(domain.PermOrganisationView.String()), handler.GetOrganizationCounts)
	rg.POST("/organizations/:id/locations", auth, requirePermission(domain.PermLocationCreate.String()), handler.CreateOrganizationLocation)
	rg.GET("/organizations/:id/locations", auth, requirePermission(domain.PermLocationView.String()), handler.ListOrganizationLocations)
	rg.GET("/locations", auth, requirePermission(domain.PermLocationView.String()), handler.ListAllLocations)
	rg.GET("/locations/:id", auth, requirePermission(domain.PermLocationView.String()), handler.GetLocationByID)
	rg.PUT("/locations/:id", auth, requirePermission(domain.PermLocationUpdate.String()), handler.UpdateLocation)
	rg.DELETE("/locations/:id", auth, requirePermission(domain.PermLocationDelete.String()), handler.DeleteLocation)
	rg.POST("/locations/:id/shifts", auth, requirePermission(domain.PermShiftCreate.String()), handler.CreateShift)
	rg.GET("/locations/:id/shifts", auth, requirePermission(domain.PermShiftView.String()), handler.ListShiftsByLocationID)
	rg.PUT("/locations/:id/shifts/:shift_id", auth, requirePermission(domain.PermShiftUpdate.String()), handler.UpdateShift)
	rg.DELETE("/locations/:id/shifts/:shift_id", auth, requirePermission(domain.PermShiftDelete.String()), handler.DeleteShift)
	rg.PUT("/organizations/:id", auth, requirePermission(domain.PermOrganisationUpdate.String()), handler.UpdateOrganization)
	rg.DELETE("/organizations/:id", auth, requirePermission(domain.PermOrganisationDelete.String()), handler.DeleteOrganization)
	rg.GET("/organizations/count", auth, requirePermission(domain.PermOrganisationView.String()), handler.GetGlobalOrganizationCounts)
}
